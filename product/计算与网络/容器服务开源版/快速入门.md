...
腾讯云容器服务开源版（Tencent Kubernetes Engine Stack，TKE Stack）是是一款面向私有化环境的开源容器编排引擎。在本教程中，您将了解如何创建容器服务开源版控制台，并使用控制台创建和管理容器集群，在集群内快速、弹性地部署您的服务。
...
1. 登录到 Installer 节点，下载 tke-installer 安装器本到 /data 目录下：
...
![img](Images/Installration/step-3-2.png)填写 TKEStack 控制台认证信息。
...
![img](https://github.com/tkestack/docs/raw/master/Images/Installration/step-6.png)
...
3. 在 “Service” 管理页面，单击 Service 所在行右侧的【删除】。如下图所示：
   ![](images/Using/deleteService.png)
4. 在弹出框中单击【确定】，即可删除服务。

#### 删除集群

1. 选择左侧导航栏中的【集群】，在“集群管理”页面选择需删除集群所在行右侧【更多】>【删除】。如下图所示：
   ![](images/Using/deleteCluster.png)
