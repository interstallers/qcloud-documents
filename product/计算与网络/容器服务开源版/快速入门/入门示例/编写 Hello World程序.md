...
```
4. <span id="search">执行以下命令，查看构建好的 helloworld镜像。</span>
```
...
sudo docker tag helloworld:v1 default.registry.tke.com/[命名空间]/helloworld:v1
...
5. 设置**实例内容器**，输入实例内容器名称为 helloworld。镜像为default.registry.tke.com/[命名空间]/helloworld。
