...
腾讯云容器服务开源版（Tencent Kubernetes Engine Stack，TKE Stack）是一款面向私有化环境的开源容器编排引擎。在本教程中，您将了解如何创建容器服务开源版控制台，并使用控制台创建和管理容器集群，在集群内快速、弹性地部署您的服务。
...
已具备4个可用节点。本文均以操作系统为 CentOS 7.6 的腾讯云云服务器为例。具体要求详见[部署环境要求](https://github.com/tkestack/tke/blob/master/docs/guide/zh-CN/installation/installation-requirement.md)。
